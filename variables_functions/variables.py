...
images = {
    ...
    "stageseparator": pygame.transform.scale(pygame.image.load(os.path.join(root_dir, "images", "decoupler.png")).convert_alpha(), (32, 5)),
    "nosecone": pygame.transform.scale(pygame.image.load(os.path.join(root_dir, "images", "nosecone.png")).convert_alpha(), (31, 32)),
    "sideseparator": pygame.transform.scale(pygame.image.load(os.path.join(root_dir, "images", "sideseparator.png")).convert_alpha(), (5, 32)),
}
blank = pygame.image.load(os.path.join(root_dir, "images", "blank.png")).convert_alpha()
